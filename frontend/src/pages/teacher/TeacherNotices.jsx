...
import { Send, PlusCircle, Compass, Pin, User, Calendar } from 'lucide-react';
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Broadcast announcements to assigned sections, tutorial batches & departments
            </p>
          </div>
            ...
            <div key={notice.id} className="card flex flex-col gap-2.5">
              ...
              <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-xs text-slate-500">
                <span className="flex items-center gap-1.5">
                  ...
                  Author: <strong className="text-slate-700">{notice.authorName}</strong> ({notice.authorRole})
                </span>
